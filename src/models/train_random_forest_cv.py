# ============================================================
# Random Forest avec train/test final + validation croisée + MLflow
...
RUN_NAME = "random_forest_balanced_cv_v1"
...
def compute_business_cost(y_true, y_pred, fn_cost=10, fp_cost=1):
    """Calcule le coût métier basé sur FP et FN."""
...
# On garde uniquement application_train, car TARGET existe uniquement ici
...
# Random Forest ne gère pas les NaN
# On remplace donc les valeurs manquantes par une valeur sentinelle
